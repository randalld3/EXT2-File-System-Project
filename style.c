...
int show_tux()
{
    ...
    printf("              88_88_");yellow();printf("::");black();printf("_88_:88888\n");
    printf("              88");yellow();printf(":::,::,:::::");black();printf("8888\n");
    printf("              88");yellow();printf("`:::::::::'`");black();printf("8888\n");
    printf("             .88  ");yellow();printf("`::::'");black();printf("    8:88.\n");
    printf("            8888            `8:888.\n");
    printf("          .8888'             `888888.\n");
    printf("         .8888:..  .::.  ...:'8888888:.\n");
    ...
    printf("    `");yellow();printf(".::.");black();printf("888.      ::          .88888888\n"); yellow();
    printf("   .::::::.");black();printf("888.    ::         ");yellow();printf(":::");black();printf("`8888'");yellow();printf(".:.\n");
    printf("  ::::::::::.");black();printf("888   '         .");yellow();printf("::::::::::::\n");
    printf("  ::::::::::::.");black();printf("8    '      .:8");yellow();printf("::::::::::::.\n");
    printf(" .::::::::::::::.");black();printf("        .:888");yellow();printf(":::::::::::::\n");
    printf(" :::::::::::::::");black();printf("88:.__..:88888");yellow();printf(":::::::::::'\n");
    printf("  ''.:::::::::::");black();printf("88888888888.88");yellow();printf(":::::::::'\n");
    printf("        '':::_:'");black();printf(" -- '' -'-' ''");yellow();printf(":_::::''\n\n");
    white();
